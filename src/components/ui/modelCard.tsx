...
const ModelCard = ({ name, icon, image, value, views, likes, location }: { name: string, icon: any, image: any, value: number, views: number, likes: number, location: string }) => {
  return (
    <div className=' w-[240px] lg:w-[250px] '>
      <div className=' flex items-center  rounded-t-md  justify-between p-3 bg-[#2B213B] '>
